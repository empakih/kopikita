...
class DatabaseSeeder extends Seeder
{
    ...
    /**
     * Isi database awal Kopikita: menu (Product), artikel (Article), dan akun admin.
     */
    public function run(): void
    {
        // ===== Produk (biji kopi & alat seduh) =====
        ...
        // ===== Artikel / Blog =====
        Article::insert([
            ['title' => 'Beda Arabika dan Robusta: Mana yang Cocok Buat Kamu?', 'slug' => 'beda-arabika-robusta', 'content' => '<p>Arabika cenderung lebih asam dengan aroma buah dan bunga, sementara robusta lebih pahit, pekat, dan tinggi kafein. Pilihan tergantung selera...</p>', 'category' => 'Edukasi', 'author' => 'Tim Kopikita', 'published_at' => now()],
            ['title' => '5 Tips Menyeduh Kopi Enak di Rumah', 'slug' => 'tips-seduh-kopi-di-rumah', 'content' => '<p>Gunakan biji segar, giling tepat sebelum menyeduh, perhatikan rasio kopi dan air, serta jaga suhu air sekitar 90-96°C...</p>', 'category' => 'Tips', 'author' => 'Tim Kopikita', 'published_at' => now()->subDays(1)],
            ['title' => 'Mengenal Metode Manual Brew: V60, Aeropress, hingga Tubruk', 'slug' => 'mengenal-manual-brew', 'content' => '<p>Setiap metode seduh menghasilkan karakter rasa yang berbeda. V60 menonjolkan kejernihan rasa, sedangkan tubruk lebih body dan pekat...</p>', 'category' => 'Edukasi', 'author' => 'Tim Kopikita', 'published_at' => now()->subDays(3)],
            ['title' => 'Resep Es Kopi Susu Gula Aren ala Kopikita', 'slug' => 'resep-es-kopi-susu-gula-aren', 'content' => '<p>Campurkan dua shot espresso, 30ml gula aren cair, dan susu segar. Tambahkan es batu secukupnya, aduk, dan nikmati...</p>', 'category' => 'Resep', 'author' => 'Tim Kopikita', 'published_at' => now()->subDays(4)],
            ['title' => 'Kenapa Biji Kopi Harus Disimpan dengan Benar?', 'slug' => 'cara-simpan-biji-kopi', 'content' => '<p>Biji kopi mudah kehilangan aroma jika terkena udara, cahaya, dan kelembapan. Simpan di wadah kedap udara dan tempat sejuk...</p>', 'category' => 'Tips', 'author' => 'Tim Kopikita', 'published_at' => now()->subDays(6)],
            ['title' => 'Sejarah Singkat Kopi di Indonesia', 'slug' => 'sejarah-kopi-indonesia', 'content' => '<p>Kopi masuk ke Nusantara sejak abad ke-17 dan kini Indonesia menjadi salah satu produsen kopi terbesar di dunia...</p>', 'category' => 'Edukasi', 'author' => 'Tim Kopikita', 'published_at' => now()->subDays(8)],
        ]);
